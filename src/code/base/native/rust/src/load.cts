...
module.exports = require("@neon-rs/load").proxy({
  platforms: {
    "win32-x64-msvc": () => require("@meridia/win32-x64-msvc"),
    "darwin-x64": () => require("@meridia/darwin-x64"),
    "darwin-arm64": () => require("@meridia/darwin-arm64"),
    "linux-x64-gnu": () => require("@meridia/linux-x64-gnu"),
    "linux-arm64-gnu": () => require("@meridia/linux-arm64-gnu"),
  },
