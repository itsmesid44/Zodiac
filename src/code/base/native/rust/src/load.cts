...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@walkdir/win32-x64-msvc'),
    'darwin-x64': () => require('@walkdir/darwin-x64'),
    'darwin-arm64': () => require('@walkdir/darwin-arm64'),
    'linux-x64-gnu': () => require('@walkdir/linux-x64-gnu'),
    'linux-arm64-gnu': () => require('@walkdir/linux-arm64-gnu')
  },
