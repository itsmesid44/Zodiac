...
var createScanner2, parse2, findNodeAtOffset2, getNodePath2, getNodeValue2;
var init_main = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/jsonc-parser/main.js"() {
    "use strict";
    init_format();
...
var ErrorCode, ClientCapabilities;
var init_jsonLanguageTypes = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes.js"() {
    init_main2();
    init_main3();
    (function(ErrorCode2) {
...
var __extends, localize2, formats, ASTNodeImpl, NullASTNodeImpl, BooleanASTNodeImpl, ArrayASTNodeImpl, NumberASTNodeImpl, StringASTNodeImpl, PropertyASTNodeImpl, ObjectASTNodeImpl, EnumMatch, SchemaCollector, NoOpSchemaCollector, ValidationResult, JSONDocument;
...
var localize3, valueCommitCharacters, propertyCommitCharacters, JSONCompletion;
var init_jsonCompletion = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonCompletion.js"() {
    init_jsonParser();
    init_main();
    init_json();
    ...
    LIB = (() => {
      ...
      var t = { 470: (t2) => {
        ...
        function r2(t3, e3) {
          for (var r3, n2 = "", o = 0, i = -1, a2 = 0, h = 0; h <= t3.length; ++h) {
            ...
            if (47 === r3) {
              ...
              } else n2.length > 0 ? n2 += "/" + t3.slice(i + 1, h) : n2 = t3.slice(i + 1, h), o = h - i - 1;
              i = h, a2 = 0;
        ...
        var n = { resolve: function() {
          ...
          if ((t3 = n.resolve(t3)) === (r3 = n.resolve(r3))) return "";
          ...
          for (var s = r3.length - h, f2 = a2 < s ? a2 : s, u = -1, c = 0; c <= f2; ++c) {
            if (c === f2) {
              if (s > f2) {
                if (47 === r3.charCodeAt(h + c)) return r3.slice(h + c + 1);
                if (0 === c) return r3.slice(h + c);
              } else a2 > f2 && (47 === t3.charCodeAt(o + c) ? u = c : 0 === c && (u = 0));
              break;
            }
            var l = t3.charCodeAt(o + c);
            if (l !== r3.charCodeAt(h + c)) break;
            47 === l && (u = c);
          }
          var p = "";
          for (c = o + u + 1; c <= i; ++c) c !== i && 47 !== t3.charCodeAt(c) || (0 === p.length ? p += ".." : p += "/..");
          return p.length > 0 ? p + r3.slice(h + u) : (h += u, 47 === r3.charCodeAt(h) && ++h, r3.slice(h));
        }, _makeLong: function(t3) {
          return t3;
        }, dirname: function(t3) {
          if (e2(t3), 0 === t3.length) return ".";
          for (var r3 = t3.charCodeAt(0), n2 = 47 === r3, o = -1, i = true, a2 = t3.length - 1; a2 >= 1; --a2) if (47 === (r3 = t3.charCodeAt(a2))) {
            if (!i) {
              o = a2;
              break;
            }
          ...
          if (void 0 !== r3 && r3.length > 0 && r3.length <= t3.length) {
            ...
            for (n2 = t3.length - 1; n2 >= 0; --n2) {
              ...
              } else -1 === s && (a2 = false, s = n2 + 1), h >= 0 && (f2 === r3.charCodeAt(h) ? -1 == --h && (i = n2) : (h = -1, i = s));
            }
            return o === i ? i = s : -1 === i && (i = t3.length), t3.slice(o, i);
          }
          for (n2 = t3.length - 1; n2 >= 0; --n2) if (47 === t3.charCodeAt(n2)) {
            if (!a2) {
              o = n2 + 1;
              break;
            }
          } else -1 === i && (a2 = false, i = n2 + 1);
          ...
          i ? (r3.root = "/", n2 = 1) : n2 = 0;
          for (var a2 = -1, h = 0, s = -1, f2 = true, u = t3.length - 1, c = 0; u >= n2; --u) if (47 !== (o = t3.charCodeAt(u))) -1 === s && (f2 = false, s = u + 1), 46 === o ? -1 === a2 ? a2 = u : 1 !== c && (c = 1) : -1 !== a2 && (c = -1);
          else if (!f2) {
            h = u + 1;
            break;
          }
        ...
        var n;
        if (r2.r(e2), r2.d(e2, { URI: () => g, Utils: () => O }), "object" == typeof process) n = "win32" === process.platform;
        ...
        function y(t3, e3) {
          for (var r3 = void 0, n2 = -1, o2 = 0; o2 < t3.length; o2++) {
            ...
            if (i2 >= 97 && i2 <= 122 || i2 >= 65 && i2 <= 90 || i2 >= 48 && i2 <= 57 || 45 === i2 || 46 === i2 || 95 === i2 || 126 === i2 || e3 && 47 === i2) -1 !== n2 && (r3 += encodeURIComponent(t3.substring(n2, o2)), n2 = -1), void 0 !== r3 && (r3 += t3.charAt(o2));
            else {
        ...
        function A2(t3, e3) {
          ...
          if (a3) {
            if (a3.length >= 3 && 47 === a3.charCodeAt(0) && 58 === a3.charCodeAt(2)) (c2 = a3.charCodeAt(1)) >= 65 && c2 <= 90 && (a3 = "/" + String.fromCharCode(c2 + 32) + ":" + a3.substr(3));
...
var localize4, BANG, PATH_SEP, FilePatternAssociation, SchemaHandle, UnresolvedSchema, ResolvedSchema, JSONSchemaService, idCounter;
var init_jsonSchemaService = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService.js"() {
    init_main();
    init_vscode_uri();
    init_strings();
    ...
    init_vscode_nls();
    init_glob();
    localize4 = loadMessageBundle();
    BANG = "!";
    PATH_SEP = "/";
    FilePatternAssociation = /** @class */
    (function() {
...
var localize5, JSONValidation, idCounter2;
var init_jsonValidation = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonValidation.js"() {
    init_jsonSchemaService();
    init_jsonLanguageTypes();
    init_vscode_nls();
    init_objects();
    localize5 = loadMessageBundle();
...
var init_jsonDocumentSymbols = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonDocumentSymbols.js"() {
    init_jsonParser();
    init_strings();
    init_colors();
...
var localize6, schemaContributions, descriptions, schema, propertyObject, description, property, schemaName;
var init_configuration = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/configuration.js"() {
    init_vscode_nls();
    localize6 = loadMessageBundle();
    schemaContributions = {
      schemaAssociations: [],
      schemas: {
...
var init_jsonSelectionRanges = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSelectionRanges.js"() {
    init_jsonLanguageTypes();
    init_main();
  }
...
var init_jsonLanguageService = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageService.js"() {
    init_jsonCompletion();
    init_jsonHover();
    init_jsonValidation();
    init_jsonDocumentSymbols();
    init_jsonParser();
    init_configuration();
    init_jsonSchemaService();
    init_jsonFolding();
    init_jsonSelectionRanges();
    init_main();
    init_jsonLanguageTypes();
    init_jsonLinks();
    init_jsonLanguageTypes();
...
var DiagnosticsAdapter, CompletionAdapter, HoverAdapter, DocumentSymbolAdapter, DocumentFormattingEditProvider, DocumentRangeFormattingEditProvider, DocumentColorAdapter, FoldingRangeAdapter, SelectionRangeAdapter;
var init_languageFeatures = __esm({
  "node_modules/monaco-editor/esm/vs/language/json/languageFeatures.js"() {
    init_monaco_editor_core();
    init_jsonLanguageService();
