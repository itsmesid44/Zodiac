...
// src/code/workbench/browser/workbench.parts/workbench.part.dev.panel/workbench.part.terminal.ts
var Terminal;
var init_workbench_part_terminal = __esm({
  "src/code/workbench/browser/workbench.parts/workbench.part.dev.panel/workbench.part.terminal.ts"() {
    init_workbench_icons();
    init_workbench_part_el();
    Terminal = class extends CoreEl {
      _tabs = [];
      _nextId = 1;
      constructor() {
        super();
      ...
      _closeTab(tabId, event) {
        ...
        if (isClosingActiveTab && this._tabs.length > 0) {
          const newActiveIndex = tabIndex < this._tabs.length ? tabIndex : this._tabs.length - 1;
