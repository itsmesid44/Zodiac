...
var localize2, MultiLineStream, _BNG, _MIN, _LAN, _RAN, _FSL, _EQS, _DQO, _SQO, _NWL, _CAR, _LFD, _WSP, _TAB, htmlScriptContents;
...
var __awaiter2, __generator2, localize3, HTMLCompletion;
    ...
    LIB = (() => {
      ...
      var t = { 470: (t2) => {
        ...
        var n = { resolve: function() {
          ...
          for (var s = r3.length - h, f = a < s ? a : s, u = -1, c = 0; c <= f; ++c) {
            if (c === f) {
              ...
              } else a > f && (47 === t3.charCodeAt(o + c) ? u = c : 0 === c && (u = 0));
              break;
            }
          ...
          if (e2(t3), 0 === t3.length) return ".";
          for (var r3 = t3.charCodeAt(0), n2 = 47 === r3, o = -1, i = true, a = t3.length - 1; a >= 1; --a) if (47 === (r3 = t3.charCodeAt(a))) {
            if (!i) {
              o = a;
              break;
            }
          ...
          if (void 0 !== r3 && r3.length > 0 && r3.length <= t3.length) {
            ...
            for (n2 = t3.length - 1; n2 >= 0; --n2) {
              ...
              } else -1 === s && (a = false, s = n2 + 1), h >= 0 && (f === r3.charCodeAt(h) ? -1 == --h && (i = n2) : (h = -1, i = s));
            }
          ...
          i ? (r3.root = "/", n2 = 1) : n2 = 0;
          for (var a = -1, h = 0, s = -1, f = true, u = t3.length - 1, c = 0; u >= n2; --u) if (47 !== (o = t3.charCodeAt(u))) -1 === s && (f = false, s = u + 1), 46 === o ? -1 === a ? a = u : 1 !== c && (c = 1) : -1 !== a && (c = -1);
          else if (!f) {
            h = u + 1;
            break;
          }
        ...
        var i, a, h = (i = function(t3, e3) {
          ...
          function t3(t4, e3, r3, n2, o2, i2) {
            void 0 === i2 && (i2 = false), "object" == typeof t4 ? (this.scheme = t4.scheme || c, this.authority = t4.authority || c, this.path = t4.path || c, this.query = t4.query || c, this.fragment = t4.fragment || c) : (this.scheme = /* @__PURE__ */ (function(t5, e4) {
              ...
              if (t5.path) {
                if (t5.authority) {
                  if (!f.test(t5.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
        ...
        function A(t3, e3) {
          ...
          if (a2) {
            if (a2.length >= 3 && 47 === a2.charCodeAt(0) && 58 === a2.charCodeAt(2)) (c2 = a2.charCodeAt(1)) >= 65 && c2 <= 90 && (a2 = "/" + String.fromCharCode(c2 + 32) + ":" + a2.substr(3));
        ...
        var O, P = r2(470), j = function() {
          ...
          for (e3 = 0; e3 < r3; e3++) for (var i2 = arguments[e3], a2 = 0, h2 = i2.length; a2 < h2; a2++, o2++) n2[o2] = i2[a2];
          return n2;
        }, U = P.posix || P;
        !(function(t3) {
...
var CompletionAdapter, HoverAdapter, DocumentHighlightAdapter, DocumentSymbolAdapter, DocumentLinkAdapter, DocumentFormattingEditProvider, DocumentRangeFormattingEditProvider, RenameAdapter, FoldingRangeAdapter, SelectionRangeAdapter;
var init_languageFeatures = __esm({
  "node_modules/monaco-editor/esm/vs/language/html/languageFeatures.js"() {
    init_htmlLanguageService();
    init_monaco_editor_core();
