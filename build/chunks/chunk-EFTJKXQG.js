...
var editor_main_default;
var init_editor_main = __esm({
  "node_modules/monaco-editor/dev/vs/editor/editor.main.css"() {
    editor_main_default = `/*!-----------------------------------------------------------
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Version: 0.29.1(38422cb1c524bf28bae0ffd6bff91c235f7fdb84)
...
// src/code/workbench/services/workbench.resources.ts
var require_workbench_resources = __commonJS({
  "src/code/workbench/services/workbench.resources.ts"() {
    init_editor_main();
    var _injectStyle = (cssText) => {
      const style = document.createElement("style");
      style.innerHTML = cssText;
      document.head.appendChild(style);
    };
    _injectStyle(editor_main_default);
  }
});
