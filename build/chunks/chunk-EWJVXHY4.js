...
var NOTHING, DRAFTABLE, DRAFT_STATE, errors, getPrototypeOf, objectCtorString, plugins, currentScope, objectTraps, arrayTraps, Immer2, immer, produce;
...
var init_redux_toolkit_modern = __esm({
  "node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs"() {
    ...
    externalAbortMessage = "External signal was aborted";
    ...
    addListener = /* @__PURE__ */ assign(/* @__PURE__ */ createAction(`${alm}/add`), {
      withTypes: () => addListener
    });
    clearAllListeners = /* @__PURE__ */ createAction(`${alm}/removeAll`);
    removeListener = /* @__PURE__ */ assign(/* @__PURE__ */ createAction(`${alm}/remove`), {
...
// src/code/workbench/common/workbench.store/workbench.store.slice.ts
var initialState, mainSlice, update_editor_tabs, update_panel_state, update_folder_structure, workbench_store_slice_default;
var init_workbench_store_slice = __esm({
  "src/code/workbench/common/workbench.store/workbench.store.slice.ts"() {
    ...
    mainSlice = createSlice({
      name: "main",
      initialState,
      reducers: {
        update_editor_tabs: (state, action) => {
          state.editor_tabs = action.payload;
        },
        update_panel_state: (state, action) => {
          state.panel_state = action.payload;
        },
        update_folder_structure: (state, action) => {
    ...
    workbench_store_slice_default = mainSlice.reducer;
  }
});
